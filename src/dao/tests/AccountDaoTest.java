...
//	}
	...
	@Test
	public void testAddCreditCardToAccount() {
		
		System.out.println("======================================");
		System.out.println("	Test Add Credit Card");
		System.out.println("======================================");
		
		SubscriberAccount subscriberAccount = new SubscriberAccount();
	    subscriberAccount.setId(1);
	    subscriberAccount.setIdUser(1);
	    subscriberAccount.setEmail("test");
	    subscriberAccount.setPassword("123");
	    subscriberAccount.setNbAllowedReservation(5);
	    
	    boolean result = accountDao.addCreditCardToAccount(subscriberAccount);
	    assertTrue(result);
	    assertTrue(subscriberAccount.getCreditCards() != null);
	    
	    System.out.println(subscriberAccount);
	}
	
	@Test
	public void testAddSubscriberCardToAccount() {
		
		System.out.println("======================================");
		System.out.println("	Test Add Subscriber Card");
		System.out.println("======================================");
	    ...
	    boolean result = accountDao.addSubscriberCardToAccount(subscriberAccount);
	    assertTrue(result);
	    assertTrue(subscriberAccount.getSubscriberCards() != null);
